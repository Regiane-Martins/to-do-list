//funcao que adiciona tarefa 
    function addTasks () {
        ...
        const removeBtn = newTasks.querySelector(".remove-btn").addEventListener("click", function() {
            removeTask(this);
        });

        //adicionar completar tarefa
        const doneBtn = newTasks.querySelector(".done-btn").addEventListener("click", function() {
            completeTask(this);
        });
